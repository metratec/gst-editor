...
#define GST_ELEMENT_BROWSER_CAPS_TREE(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), GST_TYPE_ELEMENT_BROWSER_CAPS_TREE, GstElementBrowserCapsTree))
#define GST_ELEMENT_BROWSER_CAPS_TREE_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), GST_TYPE_ELEMENT_BROWSER_CAPS_TREE, GstElementBrowserCapsTreeClass))
#define GST_IS_ELEMENT_BROWSER_CAPS_TREE(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GST_TYPE_ELEMENT_BROWSER_CAPS_TREE))
#define GST_IS_ELEMENT_BROWSER_CAPS_TREE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), GST_TYPE_ELEMENT_BROWSER_CAPS_TREE))
